...
$ptbv_resp = ecsges_ptbv_responsibility();
?>
<section aria-labelledby="ptbv-responsibility-heading" class="ecs-responsibility">
	<div class="ecs-responsibility__inner">
		<h2 id="ptbv-responsibility-heading" data-aos="fade-up" class="ecs-responsibility__heading">TRÁCH NHIỆM XÃ HỘI</h2>

		<div class="ecs-responsibility__grid" data-aos="fade-up">
			<?php foreach ( $ptbv_resp as $r ) : ?>
				<article class="ecs-responsibility__card<?php echo ! empty( $r['accent'] ) ? ' ecs-responsibility__card--accent' : ''; ?>">
