...
function ecsges_news_dates() {
	return array(
		'May 29, 2023', 'Apr 18, 2023', 'Mar 02, 2023', 'Feb 11, 2023',
		'Jan 20, 2023', 'Dec 05, 2022', 'Nov 14, 2022', 'Oct 03, 2022',
		'Sep 22, 2022', 'Aug 09, 2022', 'Jul 27, 2022', 'Jun 15, 2022',
	);
}
...
function ecsges_milestones() {
	return array(
		array(
			'years' => '2008 - 2010',
			'title' => 'ĐẶT NỀN MÓNG',
			'body'  => 'ECSGES được thành lập với các hoạt động kinh doanh và cung cấp giải pháp công nghệ thông tin, thiết bị công nghệ và văn phòng. Đây là giai đoạn đặt nền móng về năng lực vận hành, phát triển thị trường và xây dựng đội ngũ cho những bước phát triển tiếp theo.',
		),
		array(
			'years' => '2011 - 2014',
			'title' => 'MỞ RỘNG SỨ MỆNH GIÁO DỤC',
			'body'  => 'Nhận thấy nhu cầu ngày càng lớn về định hướng nghề nghiệp và phát triển nguồn nhân lực, ECSGES từng bước mở rộng sang các hoạt động hướng nghiệp, tuyển sinh và đào tạo, đánh dấu bước chuyển mình quan trọng trên hành trình phát triển.',
		),
		array(
			'years' => '2015 - 2017',
			'title' => 'CỦNG CỐ NỘI LỰC',
			'body'  => 'Tập trung nâng cao chất lượng hoạt động, ứng dụng công nghệ trong quản lý và đào tạo, đồng thời từng bước chuẩn hóa quy trình và hệ thống vận hành.',
		),
		array(
			'years' => '2018 - 2023',
			'title' => 'BỨT PHÁ TĂNG TRƯỞNG',
			'body'  => 'Mở rộng quy mô đào tạo, phát triển mạng lưới đối tác và doanh nghiệp, tạo thêm nhiều cơ hội học tập, thực tập và việc làm cho người học.',
		),
		array(
			'years' => '2024 - NAY',
			'title' => 'HỘI NHẬP VÀ PHÁT TRIỂN',
			'body'  => 'Bước vào giai đoạn phát triển mới với định hướng xây dựng hệ sinh thái giáo dục đa lĩnh vực, thúc đẩy chuyển đổi số, mở rộng hợp tác quốc tế và phát triển bền vững.',
		),
	);
}
